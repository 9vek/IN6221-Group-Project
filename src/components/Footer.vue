...
<template>
    <footer class="bg-stone-800 border border-t-2 border-stone-500 text-center lg:text-left p-4 relative z-10">
        <div class="flex justify-center my-4">
            <a href="#" class="mr-9 text-stone-50">
        ...
        <div class="py-4">
            <div class="text-stone-50 text-center">
                ...
                <a class="text-white font-extrabold" href="https://github.com/KevynTang">KevynTang</a>
            </div>
            <div class="text-stone-50 text-center">
                © 2022 Copyright:
                <a class="text-white font-extrabold" href="https://github.com/reednote-team">Reednote Project Team</a>
            </div>
        </div>
    </footer>
</template>
